...
- ✅ **Per-article social images** — 26 unique 1200×630 JPG previews under `img/og/` (generated by [tools/generate_og_images.py](tools/generate_og_images.py)) so each page has its own LinkedIn/Slack/Twitter preview, not a generic site banner
